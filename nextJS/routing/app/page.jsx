...
export default function HomePage() {
  const features= [
    { title: "Fast Performance", desc: "Experience lightning-fast load times and smooth interactions." },
    { title: "Secure", desc: "Top-notch security features to protect your data." },
    { title: "User Friendly", desc: "Intuitive design that is easy to navigate." },
    { title: "Customizable", desc: "Tailor the platform to fit your specific needs." },
  ...
  return (
    <div className="flex flex-col w-350 min-h-screen">
