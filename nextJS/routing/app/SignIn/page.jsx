...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 h-16 shadow z-50"
      style={{ backgroundImage: `url(/user1.png)`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
